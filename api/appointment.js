...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    const { name, phone, email, service, date, message, type } = body || {};
    ...
    if (type === 'message') {
      ...
      const messagesList = Array.isArray(fileData.data) ? fileData.data : [];
      const newMsg = {
        id: 'msg-' + Date.now(),
        name,
        phone,
      ...
      const appointmentsList = Array.isArray(fileData.data) ? fileData.data : [];
